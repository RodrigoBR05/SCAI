                  ...
                  while($row = mysqli_fetch_array($datos)){ ?>
                    <tr>
                        ...
                        <td class="center">
                            ...
                            <a class="open-Modal btn_delete btn-floating waves-effect waves-light red" data-id="<?php echo $row['id_producto']; ?>" href="#modalEliminarUsuario"><i class="material-icons">delete_forever</i></a>
                        </td>
                    </tr>
                <?php }
                }?>              
